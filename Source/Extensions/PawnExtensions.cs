...
namespace Degradation.Extensions
{
    public static class PawnExtensions
    {
        public static IEnumerable<Thing> GetHeldWeapons(this Pawn pawn) =>
            pawn.inventory.innerContainer.Where(t => t.def.IsRangedWeapon || t.def.IsMeleeWeapon);

        public static IEnumerable<Thing> GetAllWeapons(this Pawn pawn) =>
            pawn.equipment.GetDirectlyHeldThings().Where(t => t.def.IsRangedWeapon || t.def.IsMeleeWeapon).Concat(pawn.GetHeldWeapons());
